      ...
      try {
        ...
        if (result.success) {
          ...
          const mockCategories: LinenCategory[] = [
            { id: '1', name: 'BATH TOWELS', price_per_item: 2.50, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '2', name: 'HAND TOWELS', price_per_item: 1.25, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '3', name: 'FACE TOWELS', price_per_item: 0.75, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '4', name: 'SINGLE FITTED SHEET', price_per_item: 3.00, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '5', name: 'KING FITTED SHEET', price_per_item: 4.50, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '6', name: 'SINGLE DUVET COVER', price_per_item: 4.00, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '7', name: 'KING DUVET COVER', price_per_item: 6.00, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '8', name: 'DUVET INNER SINGLE', price_per_item: 5.00, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '9', name: 'DUVET INNER KING', price_per_item: 7.50, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '10', name: 'SMALL PILLOWS', price_per_item: 2.00, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '11', name: 'SMALL PILLOW CASES', price_per_item: 1.50, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '12', name: 'PILLOW PROTECTORS', price_per_item: 1.00, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '13', name: 'MATT PROTECTORS (K)', price_per_item: 3.50, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '14', name: 'MATT PROTECTORS (S)', price_per_item: 2.50, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '15', name: 'WATERPROOF MATTRESS PROTECTOR', price_per_item: 4.00, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '16', name: 'SHOWER MATS', price_per_item: 1.75, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '17', name: 'SINGLE FLEECE', price_per_item: 2.25, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
            { id: '18', name: 'DOUBLE FLEECE', price_per_item: 3.25, is_active: true, section: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
          ];
